    ...
    >
      <motion.div
        ...
        className={cn("absolute top-0 left-0 h-full", {
          "bg-red-300/40 dark:bg-red-400/40": variant === "red",
          "bg-green-300/40 dark:bg-green-400/40": variant === "green",
          "bg-blue-300/40 dark:bg-blue-400/40": variant === "blue",
          "bg-orange-300/40 dark:bg-orange-400/40": variant === "orange",
          "bg-gray-300/40 dark:bg-gray-400/40": variant === "grey",
        })}
        initial={{ width: "0%" }}
      />
      <span className="relative z-10 flex w-full items-center justify-center gap-2">
        ...
        {isConfirmed ? "Processing..." : isHolding ? "Release to cancel" : "Hold to Delete"}
      </span>
    </Button>
  );
}
